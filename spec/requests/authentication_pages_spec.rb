...
# Upcased here as a general safeguard against database wierdness.
...
# Uses capybara to access a controller action directly. 
					specify { expect(response).to redirect_to(signin_path) }
...
# This lets us give factory girl an option different from the default. 
